...
from attack_common import compare_dataframes
...
def main(h_min):
    ...
    df_o_r.rename(columns={8:0, 9:1, 10:2, 11:3, 12:4, 13:5, 14:6, 15:7, 16:8, 17:9}, inplace=True)

    differing_rate = compare_dataframes(df_ans, df_o_r)
